...
<body>
	...
	<hr>
	<a href="ui-halaman-admin-tambah.php"> TAMBAH DATA USER</a>
	<hr>
	<table border="2">
		<tr>
			<th width="20">No</th>
		...
		<?php
			...
			while($dt=mysql_fetch_assoc($query)){
				...
				?>
				<td>
					<a href="ui-halaman-edit.php?id=<?php echo $dt['nama'];?>">Edit</a>
					||
					<a href="delete-proses.php?id=<?php echo $dt['nama'];?>">Delete</a>
				</td>;
				<?php
				echo "</tr>";
				$no++;
